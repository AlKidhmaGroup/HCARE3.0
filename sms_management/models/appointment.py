...
class MedicalAppointment(models.Model):
    ...
    def _appointment_reminder(self):
        ...
        confirmed_appt_only = self.env['ir.config_parameter'].sudo().get_param('confirmed_appt_only') or False
        domain = [('appointment_sdate', '>', str(date_tomorrow)),('appointment_sdate', '<', str(tomorrow_end))]
        if not confirmed_appt_only:
