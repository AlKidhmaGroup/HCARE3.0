...
class ResCompany(models.Model):
    ...
    primary_color = fields.Char(string="Primary Color", default="#009688")
    primary_font_color = fields.Char(string="Primary Font Color", default="#009688")
    secondary_font_color = fields.Char(string="Secondary Font Color", default="#FFFFFF")
